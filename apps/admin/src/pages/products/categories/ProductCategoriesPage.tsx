...
//
// 목록 + 추가/수정 모달 + 삭제팝업. **사용 중 차단**: 카테고리를 쓰는 상품이 1건이라도 있으면
// 삭제 버튼을 잠그고 'N개 상품'을 알린다(고아 상품 방지 — 포트폴리오 카테고리와 같은 안전 기본값).
...
export default function ProductCategoriesPage() {
  ...
  const {
    ...
    error,
    refetch,
  } = useCrudListQuery(CATEGORY_RESOURCE, productCategoryAdapter);
