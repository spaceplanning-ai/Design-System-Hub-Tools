...
import { SETTINGS_ROUTES, SettingsGate, useSettingsAccess } from '../_shared/access';
...
const FORBIDDEN_DESCRIPTION =
  'API Key 관리는 시스템 설정 조회 권한이 있는 역할만 볼 수 있습니다. 권한이 필요하면 최상위 관리자에게 요청하세요.';
...
export default function ApiKeysPage() {
  return (
    <SettingsGate route={SETTINGS_ROUTES.apiKeys} description={FORBIDDEN_DESCRIPTION}>
      <ApiKeysView />
    </SettingsGate>
  );
}
...
function ApiKeysView() {
  ...
  const { canCreate, canRemove } = useSettingsAccess(SETTINGS_ROUTES.apiKeys);
