...
const FORBIDDEN_DESCRIPTION =
  '언어 설정은 시스템 설정 조회 권한이 있는 역할만 볼 수 있습니다. 권한이 필요하면 최상위 관리자에게 요청하세요.';
...
export default function LanguagesPage() {
  return (
    <SettingsGate route={SETTINGS_ROUTES.languages} description={FORBIDDEN_DESCRIPTION}>
      <LanguagesForm />
    </SettingsGate>
  );
}
...
function LanguagesForm() {
  ...
  const { canUpdate } = useSettingsAccess(SETTINGS_ROUTES.languages);
