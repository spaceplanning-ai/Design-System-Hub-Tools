...
import { SettingsGate, useSettingsAccess, SETTINGS_ROUTES } from '../_shared/access';
...
const FORBIDDEN_DESCRIPTION =
  '사이트 설정은 시스템 설정 조회 권한이 있는 역할만 볼 수 있습니다. 권한이 필요하면 최상위 관리자에게 요청하세요.';
...
export default function SiteSettingsPage() {
  return (
    <SettingsGate route={SETTINGS_ROUTES.site} description={FORBIDDEN_DESCRIPTION}>
      <SiteSettingsForm />
    </SettingsGate>
  );
}
...
function SiteSettingsForm() {
  ...
  const { canUpdate } = useSettingsAccess(SETTINGS_ROUTES.site);
