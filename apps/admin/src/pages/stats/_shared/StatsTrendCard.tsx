...
//
// [계열 색 — 토큰이 2개뿐이다] tokens.json 에 chart.series-1/2 만 있다. 그래서 이 카드는
// **정확히 2계열**만 그린다(현재+비교). 다계열 분해(유입경로 5종 등)는 색이 모자라 구분되지
// 않으므로 차트가 아니라 구성비 막대(ShareBarList)로 표현한다.
//   → 보고: chart.series-3..6 이 tokens.json 에 필요하다 (TOKEN-13). tokens/ 는 F1 소유다.
//
