...
//
// 스캐폴드를 '언젠가 쓸 코드'로 놔두면 그것은 죽은 코드다(클린코드 점검 축5, 임계 0건). 그래서 그렇게 두지
 ...
 * dead-code(클린코드 점검 축5, 임계 0건) 가 한 건 늘 뿐이다. 같은 판단을 crud.ts 의 WriteContext 가 이미 했다.
 */
