...
export interface TableProps {
   ...
   */
  rows: ReadonlyArray<{ id: string; cells: ReadonlyArray<ReactNode>; leading?: ReadonlyArray<ReactNode>; trailing?: ReadonlyArray<ReactNode>; onActivate?: () => void; selected?: boolean; tone?: 'danger' | 'warning' | 'success' | 'info' }>;
  /**
