...
- 입력: 계약 32종 · FS 14건 · 테스트 파일 96개 · 스토리 파일 42개
- **단언을 가진 실행 단위(= 테스트): 992건** / 단언 없는 실행 단위: 2건
...
| 2 | 계약 states 커버리지 (contracts/*.contract.json → states[]) | **blocker** | 98 | 98 | 0 | 미커버 상태 0건 (전수) | G5·G6 | PASS |
