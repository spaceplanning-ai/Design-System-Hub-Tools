...
- 입력: 계약 33종 · FS 14건 · 테스트 파일 97개 · 스토리 파일 43개
- **단언을 가진 실행 단위(= 테스트): 1001건** / 단언 없는 실행 단위: 2건
...
| 2 | 계약 states 커버리지 (contracts/*.contract.json → states[]) | **blocker** | 101 | 101 | 0 | 미커버 상태 0건 (전수) | G5·G6 | PASS |
