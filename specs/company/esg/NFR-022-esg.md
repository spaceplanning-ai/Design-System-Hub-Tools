...
| 판정 시점 | **2026-07-17 · HEAD `4b805ad`** 기준 코드 대조. 직전 판정은 `3cd3078`(F2) 기준이었고, 이후 F3a·F3b·통합(PR #8·#11·#12·#14·#16)이 공용 계층을 바꿔 일부 판정이 뒤집혔다 — §2 각 행의 근거 라인 참조 |
